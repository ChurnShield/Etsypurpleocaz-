...
OUT_DIR = "/root/NEW-AI-PROJECT/outputs/car-detail-heroes-v10"
...
# LAYER 2 — Price list (middle layer, NO CROP, full image resized, rotated -5 deg)
...
out_path = f"{OUT_DIR}/hero_visual_bundle_v10.png"
