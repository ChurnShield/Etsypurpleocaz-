# PDF Bundle — Tattoo Client Forms Build Process
...
- **Output dir:** `/root/NEW-AI-PROJECT/outputs/tattoo-forms/`
...
Outputs all 8 PDFs to `outputs/tattoo-forms/`. Also creates a ZIP bundle at `outputs/tattoo-forms/Tattoo_Studio_Client_Forms_Bundle.zip` if the bundling step is enabled.
