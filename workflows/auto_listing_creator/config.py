...
# ── Shared constants from root config ──────────────────────────────────────
PAGINATION_MAX_PAGES = 50
PLAYWRIGHT_PAGE_TIMEOUT_MS = 30_000
LLM_REQUEST_TIMEOUT_SECONDS = 120
CANVA_POLL_MAX_ITERATIONS = 20
CANVA_POLL_MAX_WAIT_SECONDS = 8
MIN_PATTERN_CONFIDENCE = 0.7
SLOW_TOOL_THRESHOLD_MS = 10000
BIG_BRAIN_MIN_WORKFLOWS = 2
BIG_BRAIN_MIN_RUNS_PER_WORKFLOW = 10
BIG_BRAIN_CACHE_TTL_SECONDS = 300
BIG_BRAIN_FAILURE_RATE_CRITICAL = 0.50
BIG_BRAIN_FAILURE_RATE_DEGRADED = 0.25
BIG_BRAIN_RECURRING_ERROR_THRESHOLD = 10
BIG_BRAIN_TIMEOUT_THRESHOLD = 5
BIG_BRAIN_DB_MAX_SIZE_MB = 500
BIG_BRAIN_PERF_DEGRADATION_FACTOR = 1.5
